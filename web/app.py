"""
Florisoft – Streamlit only (no FastAPI needed).
Run from project root: streamlit run web/app.py
Deploy: one Streamlit app (e.g. Streamlit Community Cloud or Render).
"""
import sys
